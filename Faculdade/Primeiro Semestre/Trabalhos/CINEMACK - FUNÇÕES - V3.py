    ...
    while True:
        ...
        if tipo_ingresso_sessao in [1, 2, 3]:
            while True:
                ...
                i, j = divmod(assento_index, assentos_por_fileira)  # Converte o índice linear para índice de fileira e assento
...
def doces_salgados():
    global pipoca_simples, pipoca_grande, chocolate, refrigerante, bala
    ...
    while True:
        ...
        total_ganho = (pipoca_simples * 5 + pipoca_grande * 10 + chocolate * 7 + refrigerante * 6 + bala * 3)
...
def relatorio():
    ...
    print(f"Doces e Bebidas: R${total_ganho:.2f}")
